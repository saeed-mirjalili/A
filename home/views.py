    ...
    if request.method == 'POST':
        ...
        if language == 'en':
            ...
            if most_common_word:
                ...
                body = '\n'.join(sentence.strip() for sentence in sentences_with_common_word)

            else:
                print("لیست خالی است.")

        form.initial['body'] = filtered_words
